...
try:
    ...
    logging.error("Agisoft Metashape is not available. Please run within Metashape Python environment.")
    raise e
...
class PhotogrammetryEngine:
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        logging.info(f"PhotogrammetryEngine initialized. Engine: {self.engine}")
    ...
    def reconstruct_point_cloud(self, images: List[np.ndarray], image_labels: List[str] = None) -> PointCloud:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            logging.info(f"Added {len(image_file_paths)} RGB photos to chunk.")
            ...
            try:
                ...
                logging.info("Image alignment and camera optimization completed.")
                ...
                logging.info("Dense point cloud construction completed.")
            ...
            logging.info(f"Extracted {points_np.shape[0]} valid 3D points.")
